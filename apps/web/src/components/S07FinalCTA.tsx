...
const STATUS_ITEMS = [
  { val: "3", color: "var(--nexus-cyan)", label: "Hard 0G components" },
  { val: "4", color: "var(--nexus-pink)", label: "Product phases" },
  { val: "V1", color: "var(--nexus-gold)", label: "Launch target" },
];

export default function S07FinalCTA() {
  return (
    <section id="build" className="nexus-s7-section">
        ...
        <div className="nexus-s7-inner">
          <div className="nexus-s7-core" data-s7-collider="core">
            ...
            <div className="nexus-s7-coin" data-s7-collider="coin">
              <span className="font-arcade text-6xl leading-none">A</span>
            </div>
          </div>

          <div className="nexus-s7-eyebrow" data-s7-collider="eyebrow">
            <span className="font-arcade text-2xl leading-none">//</span>
            <span className="text-xs font-bold uppercase tracking-[0.28em]">Build forward</span>
          </div>

          <h2 className="nexus-s7-title">
            <span className="line-one" data-s7-collider="headline">Build trusted</span>
            <br />
            <span className="line-two" data-s7-collider="headline">agents on 0G</span>
          </h2>

          <p className="nexus-s7-copy" data-s7-collider="subtitle">
            AgentVault is the platform vision for launching, governing, verifying, and monetizing AI agents on 0G with a product structure that can scale beyond a single hackathon demo.
          </p>
          ...
          <div className="nexus-s7-actions" data-s7-collider="buttons">
            ...
            <a href="#roadmap" className="nexus-s7-button-secondary" data-s7-collider="button">
              View Roadmap
            </a>
          </div>
